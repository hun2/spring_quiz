	...
	<div class="container">
		<form action="/lesson04/quiz01/add_seller" method="post">
			...
			<div class="form-group">
				...
				<input type="text" id="profileImageUrl" name="profileImageUrl" class="form-control col-8" placeholder="프로필 url 입력하세요">
			</div>
			<div class="form-group">
				<label for="temperature">온도</label>
				<input type="text" id="temperature" name="temperature" class="form-control col-3" placeholder="온도 입력하세요">
			</div>
